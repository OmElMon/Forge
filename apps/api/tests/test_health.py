...
def test_migration_head_matches_latest_revision() -> None:
    assert migration_head() == "20260827_0013"
...
async def failing_db_override():
    session = FakeSession("20260827_0013")
...
def test_status_reports_database_and_migration_health() -> None:
    ...
    assert payload["checks"]["migrations"]["current"] == "20260827_0013"
    assert payload["checks"]["migrations"]["head"] == "20260827_0013"
