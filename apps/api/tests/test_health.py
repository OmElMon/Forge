...
async def healthy_db_override():
    yield FakeSession("20260812_0009")


async def stale_db_override():
    yield FakeSession("20260630_0001")
...
def test_status_reports_database_and_migration_health() -> None:
    ...
    assert payload["checks"]["migrations"]["current"] == "20260812_0009"
    assert payload["checks"]["migrations"]["head"] == "20260812_0009"
