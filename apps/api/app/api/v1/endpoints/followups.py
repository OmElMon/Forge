...
from app.services.automation_rules import materialize_pending_followups, resolve_followup
...
async def list_followups(
    ...
    # Materialize any pending follow-ups from the event stream before listing so
    # the queue is current whether or not a background worker is running.
